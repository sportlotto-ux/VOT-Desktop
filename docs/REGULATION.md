...
| 2.2 | 2026-08-30 | Критический фикс: аудио-загрузка с включённой озвучкой писалась во временную .vot-process-* папку и удалялась после «успеха» — теперь work-dir только для video+translate; чекбокс озвучки блокируется для Audio; live-регрессионный тест |
